...
# User input
print("\n=== Password Generator By Nido ===")  # Added for clarity
...
print("\n=== Results ===")  # Added separation
print("Generated Password:", password)  # This will now show in terminal

# Save to file
save_password(password)
print(f"Password saved to 'passwords_generated.txt'")
print("=================")  # Added visual separation
